...
interface IWaveTopIllustrationProps {}

const WaveTopIllustration: React.FunctionComponent<IWaveTopIllustrationProps> = props => {
	const {} = props;
	return (
		<svg
			width="767"
		...
		>
			...
			<defs>
				...
				>
					<stop stopColor="#7AD123" />
					<stop offset="0.520833" stopColor="#FF7F11" />
...
export default WaveTopIllustration;
